---
layout: default
title: Riesgos Ergonómicos en el Sector Informático
---

<section class="ergonomia-detallada">
    <p style="font-size: 1.2rem; color: var(--accent-manuel); font-weight: 500;">
...
<h2 style="color: var(--accent-manuel);">5. Normativa Aplicable (España)</h2>
    <p>Es importante saber que la salud laboral está protegida por ley. El <strong>Real Decreto 488/1997</strong> establece las disposiciones mínimas de seguridad y salud relativas al trabajo con equipos que incluyen pantallas de visualización.</p>
    <blockquote>
...
.nav-link:hover {
    ...
    .ergonomia-detallada h2 {
        margin-top: 2rem;
        border-bottom: 1px solid rgba(56, 189, 248, 0.2);
        padding-bottom: 10px;
    }
    .ergonomia-detallada h3 {
        color: #94a3b8;
        margin-top: 1.5rem;
    }
    .ergonomia-detallada ul {
        line-height: 2;
    }
